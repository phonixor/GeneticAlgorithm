...
#PBS -lwalltime=7:00:00 -lnodes=1
#
...
for (( i=1; i<=nprocs; i++ )) ; do
	...
	echo nr o :$i
	python experiment.py -n $PBS_ARRAYID-$i $HOME/stage/python/models/test4 $HOME/stage/python/models/4geneWithVarProduction.model &
done
wait
